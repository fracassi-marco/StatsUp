...
class Activities2(
    ...
    fun filterByMonth(position: Int): Activities2 {
        monthPosition = position
        return this
    }

    fun filterByYear(position: Int): Activities2 {
    ...
    fun addMonths(amount: Int) =Activities2(activities, provider).filterByMonth(monthPosition + amount)

    fun addYears(amount: Int) = Activities2(activities, provider).filterByYear(yearPosition + amount)
