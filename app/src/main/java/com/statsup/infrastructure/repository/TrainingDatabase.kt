...
abstract class TrainingDatabase: RoomDatabase() {
    ...
    companion object {
        ...
        private val MIGRATION_15_16 = object : Migration(15, 16) {
            override fun migrate(db: SupportSQLiteDatabase) {
                db.execSQL("ALTER TABLE training ADD COLUMN elevationPointsJson TEXT")
            }
        }

        private val MIGRATION_16_17 = object : Migration(16, 17) {
            override fun migrate(db: SupportSQLiteDatabase) {
                db.execSQL("ALTER TABLE training ADD COLUMN startLocationLabel TEXT")
                db.execSQL("ALTER TABLE training ADD COLUMN endLocationLabel TEXT")
            }
        }

        private val MIGRATION_17_18 = object : Migration(17, 18) {
            override fun migrate(db: SupportSQLiteDatabase) {
                db.execSQL("ALTER TABLE training ADD COLUMN peakName TEXT")
                db.execSQL("ALTER TABLE training ADD COLUMN peakElevation REAL")
            }
        }
